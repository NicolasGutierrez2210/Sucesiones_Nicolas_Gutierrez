...
sucesor :: Int -> Int
sucesor n = n + 1   -- devuelve el siguiente número

-- Definición de la función predecesora
predecesor :: Int -> Int
predecesor n = n - 1   -- devuelve el número anterior
...
-- Multiplicación de dos enteros positivos usando sumas repetidas
multiplicacion :: Int -> Int -> Int
multiplicacion _ 0 = 0   -- caso base: todo número por 0 es 0
...
division a b
    ...
    | otherwise = sucesor (division (resta a b) b)   -- cuenta cuántas veces se puede restar b de a
